...
<head>
  ...
  <meta name="teacher-os-build" content="18.2.1-sprint2a-batch1">
  <link rel="manifest" href="manifest.json">
  <link rel="icon" href="icon-192.svg">
  <link rel="stylesheet" href="style.css?v=18.2.2-s2a">
  <link rel="stylesheet" href="sidebar-v162.css?v=18.2.2-s2a">
  <link rel="stylesheet" href="sprint1-dashboard.css?v=18.2.2-s2a">
  <link rel="stylesheet" href="sprint2a-command-center.css?v=18.2.2-s2a">
  <link rel="stylesheet" href="sprint2a-student-center.css?v=18.2.2-s2a">
...
<body>
  ...
  <script src="sprint1-storage.js?v=18.2.2-s2a"></script>
  <script src="sprint1-events.js?v=18.2.2-s2a"></script>
  <script src="sprint1-state.js?v=18.2.2-s2a"></script>
  <script src="sprint1-calendar.js?v=18.2.2-s2a"></script>
  <script src="sprint1-dashboard.js?v=18.2.2-s2a"></script>
  <script src="sprint2a-command-center.js?v=18.2.2-s2a"></script>
  <script src="sprint2a-student-center.js?v=18.2.2-s2a"></script>
  <script src="sprint1-navigation.js?v=18.2.2-s2a"></script>
  <script src="sprint1-diagnostics.js?v=18.2.2-s2a"></script>
  <script src="sprint1-compat.js?v=18.2.2-s2a"></script>
  <script src="app.js?v=18.2.2-s2a"></script>
</body>
</html>
